...
Blockly.Blocks['extension_spotpear_display'] = {
  /**
   * @this Blockly.Block
   */
  init: function() {
    this.jsonInit({
      ...
      "args0": [
        {
          "type": "field_image",
          "src": Blockly.mainWorkspace.options.pathToMedia + "extensions/spotpear-block-icon.svg",
          "width": 40,
          "height": 40
        },
        {
...
Blockly.Blocks['extension_spotpear_display16x16'] = {
  /**
   * @this Blockly.Block
   */
  init: function() {
