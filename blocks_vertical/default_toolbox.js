...
Blockly.Blocks.defaultToolbox = '<xml id="toolbox-categories" style="display: none">' +
  ...
  '<category name="Extensions" id="extensions" colour="#FF6680" secondaryColour="#FF4D6A" ' +
    ...
    '<block type="extension_microbit_display" id="extension_microbit_display">' +
      ...
      '</value>' +
    '</block>' +
    '<block type="extension_spotpear_display" id="extension_spotpear_display">' +
      '<value name="MATRIX">' +
        '<shadow type="matrix">' +
          '<field name="MATRIX">0101010101100010101000100</field>' +
        '</shadow>' +
      '</value>' +
    '</block>' +
    '<block type="extension_spotpear_display16x16" id="extension_spotpear_display16x16">' +
      '<value name="MATRIX">' +
        '<shadow type="matrix">' +
          '<field name="MATRIX"></field>' +
        '</shadow>' +
      '</value>' +
    '</block>' +
